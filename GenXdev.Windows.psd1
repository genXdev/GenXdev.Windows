...
@{
  ...
  RequiredModules      = @(@{ModuleName = 'GenXdev.Data'; ModuleVersion = '1.110.2025' }, @{ModuleName = 'GenXdev.Helpers'; ModuleVersion = '1.110.2025' }, @{ModuleName = 'GenXdev.FileSystem'; ModuleVersion = '1.110.2025' });
