...
@{
  ...
  RequiredModules      = @(@{ModuleName = 'GenXdev.Helpers'; ModuleVersion = '1.56.2024' }, @{ModuleName = 'GenXdev.FileSystem'; ModuleVersion = '1.56.2024' });

  # Assemblies that must be loaded prior to importing this module
  RequiredAssemblies   = @(

    ".\\dependencies\\System.Management.Automation.dll",
    ".\\dependencies\\GenXdev.Windows.dll"
  )
  ...
  ".\\dependencies\\GenXdev.Windows.deps.json",
  ".\\dependencies\\GenXdev.Windows.dll",
  ".\\dependencies\\GenXdev.Windows.pdb",
