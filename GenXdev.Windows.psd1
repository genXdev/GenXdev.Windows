...
RequiredModules = @(@{ModuleName = 'GenXdev.Data'; ModuleVersion = '1.216.2025'; })
...
FunctionsToExport = 'Add-WireGuardPeer', 'CurrentUserHasElevatedRights', 
               ...
               'Pop-Window', 'Push-Window', 'Remove-WireGuardPeer', 
               'Reset-WireGuardConfiguration', 'Send-Key', 'Set-ClipboardFiles', 
...
AliasesToExport = 'folder', 'getclipfiles', 'gusers', 'gwin', 'HasNoVirus', 'invokekeys', 
               ...
               'setclipfiles', 'virusscan', 'window', 'wp', 'wps'
