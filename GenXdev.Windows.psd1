...
@{
  ...
  RequiredModules      = @(@{ModuleName = 'GenXdev.Helpers'; ModuleVersion = '1.74.2024' }, @{ModuleName = 'GenXdev.FileSystem'; ModuleVersion = '1.74.2024' });
  ...
  ".\\lib\\GenXdev.Windows.deps.json",
  ".\\lib\\GenXdev.Windows.dll",
  ".\\lib\\GenXdev.Windows.pdb",
