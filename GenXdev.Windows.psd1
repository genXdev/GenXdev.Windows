...
RequiredModules = @(@{ModuleName = 'Microsoft.WinGet.Client'; ModuleVersion = '1.11.410'; }, 
               @{ModuleName = 'GenXdev.Data'; ModuleVersion = '3.24.2026'; })
...
AliasesToExport = 'folder', 'gcbf', 'getclipfiles', 'gusers', 'gwp', 'HasNoVirus', 'invokekeys', 
               'nice', 'popw', 'pushw', 'scbf', 'sendkeys', 'setclipfiles', 'updatewindows', 
               'virusscan', 'wp', 'wps'
...
FileList = '.gitignore', 'GenXdev.Windows.csproj', 'GenXdev.Windows.psd1', 
               ...
               'powershell.jpg', 'README.md', 'lib\GenXdev.CoreHelpers.dll', 
               'lib\GenXdev.CoreSockets.dll', 'lib\GenXdev.Windows.deps.json', 
