...
RequiredModules = @(@{ModuleName = 'GenXdev.Data'; ModuleVersion = '1.190.2025'; })
...
FunctionsToExport = 'Add-WireGuardPeer', 'CurrentUserHasElevatedRights', 
               ...
               'Get-ActiveUser', 'Get-ChildProcesses', 'Get-CurrentFocusedProcess', 
               'Get-DesktopScalingFactor', 'Get-ForegroundWindow', 
               'Get-KnownFolderPath', 'Get-MonitorCount', 'Get-MpCmdRunPath', 
               'Get-OpenedFileHandleProcesses', 'Get-PowershellMainWindow', 
               'Get-PowershellMainWindowProcess', 'Get-Window', 
               'Get-WireGuardPeerQRCode', 'Get-WireGuardPeers', 
               'Get-WireGuardStatus', 'Initialize-ScheduledTaskScripts', 
               'Pop-Window', 'Push-Window', 'Remove-WireGuardPeer', 
               'Reset-WireGuardConfiguration', 'Send-Key', 'Set-ForegroundWindow', 
