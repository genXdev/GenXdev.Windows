...
RequiredModules = @(@{ModuleName = 'Microsoft.WinGet.Client'; ModuleVersion = '1.11.410'; }, 
               @{ModuleName = 'GenXdev.Data'; ModuleVersion = '1.302.2025'; })
...
FileList = '.gitignore', 'GenXdev.Windows-Help.xml', 'GenXdev.Windows.csproj', 
               'GenXdev.Windows.psd1', 'GenXdev.Windows.psm1', 
               'GenXdev.Windows.WireGuard.psm1', 'LICENSE', 'powershell.jpg', 
               'README.md', 'lib\GenXdev.Windows.deps.json', 
