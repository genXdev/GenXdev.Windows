...
RequiredModules = @(@{ModuleName = 'Microsoft.WinGet.Client'; ModuleVersion = '1.11.410'; }, 
               @{ModuleName = 'GenXdev.Data'; ModuleVersion = '1.236.2025'; })
...
NestedModules = @('GenXdev.Windows.WireGuard.psm1')
...
FunctionsToExport = 'Add-WireGuardPeer', 'CurrentUserHasElevatedRights', 
               ...
               'Get-Window', 'Get-WireGuardPeerQRCode', 'Get-WireGuardPeers', 
...
AliasesToExport = 'folder', 'Get-WindowsIsUpToDate', 'getclipfiles', 'gusers', 'gwin', 
               'HasNoVirus', 'invokekeys', 'nice', 'popw', 'pushw', 'sendkeys', 
               'Set-TaskAlign', 'setaswallpaper', 'setclipfiles', 'updatewindows', 
...
FileList = 'GenXdev.Windows.psd1', 'GenXdev.Windows.psm1', 
               ...
               'Tests\GenXdev.Windows\Invoke-WindowsUpdate.Tests.ps1', 
